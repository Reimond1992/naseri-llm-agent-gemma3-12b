...
This guide shows how to run the LLM Agent API locally using Python and FastAPI. The agent uses Ollama Gemma3:12B to answer user messages.
...
Ollama API must be running on http://localhost:11434/api/generate
...
Make sure Ollama is running before starting FastAPI, otherwise requests will fail

🔹 11. Recommended Usage

For a clean environment, always use virtual environment

For repeated usage, you can run FastAPI in the background using:
